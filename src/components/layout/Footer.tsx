...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="w-full bg-academic-green text-canvas pt-14 sm:pt-16 pb-12 border-t border-academic-green-dark mt-auto">
      <Container size="default">
        {/* Main Footer Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 mb-12 text-center sm:text-left items-center sm:items-start">
          ...
          <div className="lg:col-span-3 flex flex-col items-center sm:items-start space-y-3">
            <h3 className="font-serif font-semibold text-base text-amber-200 tracking-wide">
              Admissions
            </h3>
            <ul className="space-y-2 text-sm text-canvas/80">
        ...
        <div className="pt-8 border-t border-canvas/10 flex flex-col sm:flex-row items-center justify-between text-xs text-canvas/60 gap-4 text-center sm:text-left">
